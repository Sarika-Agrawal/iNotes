...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="/php.jpg"><img src="/CRUD/php.jpg" height="28px" alt=""> </a>
  ...
  <script>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are yoy sure you want to delete this note?")) {
          console.log("yes");
          window.location = `/CRUD/index.php?delete=${sno}`;
          // ToDo: Create a form and post request to submit a form
        }
        else {
          console.log("no");
        }
